...
<!-- Mirrored from colorlib.com//polygon/adminty/default/auth-sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Nov 2018 03:13:37 GMT -->
...
<body class="fix-menu">
    ...
    <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}"  class="md-float-material form-material">
                      @csrf
